...
<p> We can then break these pixels down across the area to find that there are approximately .30 meters per pixel covered in the data set. In the United States Customary System (USCS) of measurements, this is equivalent to around 1 foot per pixel. </p>
